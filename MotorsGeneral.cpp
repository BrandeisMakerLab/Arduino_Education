/*Used here to demonstrate motor driving, and is my own code https://github.com/BrandeisMakerLab/Robotics_ZumoAutomation -Jacob Smith
...
//setSpeeds method with icnluded delay to avoid repeated code
void MotorsGeneral::setSpeeds(int leftSpeed, int rightSpeed, int timeInMillis){
		//call set speeds method to set speeds
